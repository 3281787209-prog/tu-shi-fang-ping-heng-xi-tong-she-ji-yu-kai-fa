import {
  vtkDataSet$1
} from "./chunk-IA2MSYVA.js";
import {
  quat_exports,
  vec3_exports,
  vtkBoundingBox,
  vtkPlane$1
} from "./chunk-MZ3NSSUE.js";
import {
  vtkPoints$1
} from "./chunk-NZDANNRW.js";
import {
  VtkDataTypes,
  vtkDataArray$1
} from "./chunk-ABJDZPEO.js";
import {
  add,
  cross,
  determinant2x2,
  ...
  solveLinearSystem,
  subtract
} from "./chunk-6VSP3FPZ.js";
import {
  TYPED_ARRAYS,
  macro,
  vtk
} from "./chunk-K5O4FLM5.js";
...
function extend2(publicAPI, model, initialValues = {}) {
...
var newInstance2 = macro.newInstance(extend2, "vtkCell");
var vtkCell$1 = {
...
function vtkCellLinks(publicAPI, model) {
  ...
  publicAPI.allocate = (numLinks, ext = 1e3) => {
...
function extend3(publicAPI, model, initialValues = {}) {
  Object.assign(model, DEFAULT_VALUES2, initialValues);
  macro.obj(publicAPI, model);
  vtkCellLinks(publicAPI, model);
}
var newInstance3 = macro.newInstance(extend3, "vtkCellLinks");
var vtkCellLinks$1 = {
...
function vtkCellTypes(publicAPI, model) {
  ...
  publicAPI.allocate = (sz = 512, ext = 1e3) => {
...
function extend4(publicAPI, model, initialValues = {}) {
...
var newInstance4 = macro.newInstance(extend4, "vtkCellTypes");
var vtkCellTypes$1 = {
...
function extend5(publicAPI, model, initialValues = {}) {
...
var newInstance5 = macro.newInstance(extend5, "vtkLine");
var vtkLine$1 = {
...
function extend6(publicAPI, model, initialValues = {}) {
...
var newInstance6 = macro.newInstance(extend6, "vtkPointSet");
var vtkPointSet$1 = {
...
function extend7(publicAPI, model, initialValues = {}) {
...
var newInstance7 = macro.newInstance(extend7, "vtkPolyLine");
var vtkPolyLine$1 = {
...
function extend8(publicAPI, model, initialValues = {}) {
  Object.assign(model, DEFAULT_VALUES7, initialValues);
  macro.obj(publicAPI, model);
  vtkPriorityQueue(publicAPI, model);
}
var newInstance8 = macro.newInstance(extend8, "vtkPriorityQueue");
...
function extend9(publicAPI, model, initialValues = {}) {
  Object.assign(model, DEFAULT_VALUES8, initialValues);
  macro.obj(publicAPI, model);
  vtkPolygon(publicAPI, model);
}
var newInstance9 = macro.newInstance(extend9, "vtkPolygon");
var vtkPolygon$1 = {
...
var DEFAULT_VALUES9 = {};
function extend10(publicAPI, model, initialValues = {}) {
  Object.assign(model, DEFAULT_VALUES9, initialValues);
  vtkCell$1.extend(publicAPI, model, initialValues);
  vtkTriangle(publicAPI, model);
}
var newInstance10 = macro.newInstance(extend10, "vtkTriangle");
var vtkTriangle$1 = {
...
function extend11(publicAPI, model, initialValues = {}) {
  Object.assign(model, DEFAULT_VALUES10, initialValues);
  vtkCell$1.extend(publicAPI, model, initialValues);
  vtkQuad(publicAPI, model);
}
var newInstance11 = macro.newInstance(extend11, "vtkQuad");
var vtkQuad$1 = {
...
function extend12(publicAPI, model, initialValues = {}) {
...
var newInstance12 = macro.newInstance(extend12, "vtkTriangleStrip");
...
function extend13(publicAPI, model, initialValues = {}) {
...
var newInstance13 = macro.newInstance(extend13, "vtkPolyData");
var vtkPolyData$1 = {
...
export {
  CELL_FACTORY,
  extend13 as extend,
  newInstance13 as newInstance,
  vtkPolyData$1
};
//# sourceMappingURL=chunk-6NRYVP7B.js.map
