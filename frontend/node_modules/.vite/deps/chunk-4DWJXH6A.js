...
function vtkLookupTable(publicAPI, model) {
  ...
  publicAPI.setTable = (table) => {
    ...
    if (table.getNumberOfComponents() !== 4) {
      vtkErrorMacro2("Expected 4 components for RGBA colors");
      return false;
    }
    if (table.getDataType() !== VtkDataTypes.UNSIGNED_CHAR) {
      vtkErrorMacro2("Expected unsigned char values for RGBA colors");
      return false;
    }
...
var newInstance2 = macro.newInstance(extend2, "vtkLookupTable");
...
//# sourceMappingURL=chunk-4DWJXH6A.js.map
